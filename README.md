...
## SIDE NOTE
- I forgot discord changed the url link every 24 hours so all imgs have been put in the Pictures folder, im to lazy to relink all those but it's easy to tell which go with which statement. Might fix later uh huh
